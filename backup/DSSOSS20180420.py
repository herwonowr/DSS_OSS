...
import os
if not os.path.exists(r'DB.csv'):
	INITIALIZE_DB()
...
#Add K2R FUNCTION_B
		...
		self.K2R_B_Reams2B_LIST.clicked.connect(lambda: ADD_REALMS2LIST(self.Combo_Region_B.currentText(),self.realm_B.displayText(),self.LIST_B.displayText()))
