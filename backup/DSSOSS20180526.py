...
#DB BUTTON
		...
		self.BKP_DB = QPushButton('BACKUP_DB',self)
		self.BKP_DB.move(X11,Y_start+Y_step*0)
		self.BKP_DB.clicked.connect(lambda:BACKUP_DB())
		
		self.RST_DB = QPushButton('Restore_DB',self)
		self.RST_DB.move(X12,Y_start+Y_step*0)
