...
class MASSIVE_RULE(QMainWindow, Ui_MASSIVE_RULE):
	...
	def show_rule(self):	
		#f=["adjacentSourcePeerName","adjacentSourceRealmName",'appId',"condition",'consequence','description','destHost','destRealm','dscRuleGroup','id','priority','ruleType','srcHost','srcRealm']
		global RULES
