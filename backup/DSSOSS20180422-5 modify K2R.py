...
def K2R(Region,Realms2,List1,Realms1,Name1,Name2):
	...
	if Region =='NA':
		...
		if Name1 =='Verizon Wireless' or Name2 =='Verizon Wireless':
			...
			for realm1 in Realms1:
				for realm2 in Realms2:
					...
					response=Name1+':'+realm1+'>'+Name2+':'+realm2+suffix+' RF '+response
					Outputlist_2.append(response)
		...
		K2RREALMS=[]
		for realm in Realms2:
			K2RREALMS.append(realm)
			K2RREALMS.append(realm+suffix)
		for realm in K2RREALMS:
			ADD_REALMS2LIST(Region,realm,LIST1)		
