...
def FTRHUB(name1,name1,realms1,realms2):
	Outputlist_1=[]
	Outputlist_2=[]
	Outputlist_3=[]
	Outputlist_4=[]
...
#Add K2R FUNCTION_B
	...
	def route_filter(self):
		...
		for route in filtered_route_owner:
			...
			route_info=route['o_name']+'-----'+route['r_name']+'-----'+route['o_owner']+'-----'+str(route['electing_date'])+'-----'+route['o_real_hub']+'<>'+route['dra1']+'<>'+route['dra2']+'<>'+route['dra3']+'<>'+route['r_real_hub']+'-----'+route['status']
