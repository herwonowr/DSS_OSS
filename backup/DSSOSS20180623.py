...
# read user and pwd
if not os.path.exists('.\\file\rmtcredential.txt'):
	
input=open('.\\file\rmtcredential.txt)
...
## code for OPB only end
	...
	def call_rmt(self):
		...
		rmt_user='Jason'
		rmt_password='JasonRMT'
		rmt_route_edit(url,rmt_flag,rmt_user,rmt_password)
