...
class SECURITY_FILTER(QMainWindow, Ui_SECURITY_FILTER):
	...
	def __init__(self, parent=None):    
		...
		self.TWO_D_MAP_DELETE.clicked.connect(lambda:(self.DELETE_2D_MAPCACHE(self.TWO_D_MAP_REGION.currentText(),self.TWO_D_MAPCACHE.text(),self.TWO_D_MAP_KEY1.toPlainText())))
